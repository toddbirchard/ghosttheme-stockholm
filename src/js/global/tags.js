export function load_tag_icons() {
  var tags = {
    ...
    roundup: '<i class="far d fa-undo-alt"></i>',
    excel: '<i class="far d fa-table"></i>',
    devops: '<i class="far d fa-server"></i>',
    pandas: '<i class="far d fa-paw"></i>',
    ...
    codesnippetcorner: '<i class="far d fa-laptop-code"></i>',
    saas: '<i class="far d fa-desktop-alt"></i>',
    datavis: '<i class="far d fa-chart-pie"></i>',
    plotly: '<i class="far d fa-chart-bar"></i>',
    postgresql: '<i class="far d fa-elephant"></i>',
    bigdata: '<i class="fas fa-chart-network"></i>',
    ...
    dataengineering: '<i class="fas fa-wrench"></i>',
    apache: '<i class="far d fa-feather-alt"></i>',
    spark: '<i class="fas fa-star"></i>'
  };
