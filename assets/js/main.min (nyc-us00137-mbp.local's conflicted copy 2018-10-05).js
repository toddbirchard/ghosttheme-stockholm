...
/*===========================
 ...
 ==========================*/
var themeApp = {
  initializeAndLogin: function initializeAndLogin() {
    stitchClient.auth.loginWithCredential(new AnonymousCredential()).then(function (user) {
      console.log("Logged in as anonymous user with id ".concat(user.id));
    });
  },
