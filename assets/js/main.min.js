...
$(document).ready(function(){$("article img").materialbox(),$("pre").append('<div class="fullscreenbtn"><i class="fal fa-square"></i></div>'),$(".fullscreenbtn").on("click",function(){var e=$(window).height();$(this).closest("pre").addClass("fullscreen"),$(this).closest("pre").css("max-height","none"),$(this).closest("pre").css("height",e)})});
